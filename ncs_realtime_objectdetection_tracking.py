# USAGE
# python3 ncs_realtime_objectdetection_tracking.py --graph Graphs/graphycroom30000 --confidence 0.5 --display 1 --save 1
...
ap.add_argument("-r", "--rotation", type=int, default=90, help="rotation of the camera view")
ap.add_argument("-f", "--fps", type=int, default=5, help="captured frames per sec")
...
try:
    ...
    for frame in camera.capture_continuous(rawCapture, format="bgr", use_video_port=True):
        ...
        image_for_show = cv2.resize(image_for_show, DISPLAY_DIMS)
        ...
        print("Go In Count: {}".format(goInCount))
        print("Go Out Count: {}".format(goOutCount))
        print("People Inside: {}".format(numPeopleInside))
