# USAGE
# python3 ncs_video_count_tracking_opt.py --video TestVideos/room2.avi --graph Graphs/graphycroom30000 --confidence 0.5 --display 1 --save 1
...
while cap.isOpened():
    try:
        ...
        logger.info("Go In Count: {}".format(goInCount))
        logger.info("Go Out Count: {}".format(goOutCount))
        logger.info("People Inside: {}".format(numPeopleInside))
